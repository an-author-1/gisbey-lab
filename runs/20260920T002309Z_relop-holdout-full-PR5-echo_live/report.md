# Run 20260920T002309Z_relop-holdout-full-PR5-echo_live

**Case:** relop-holdout-full-PR5-echo  
**Mode:** LIVE  
...
> (full page PR5 — see input.json for exact text)
...
- probabilities:
  ...
  - PR1: 0.01
  - PR2: 0.08
  - PR3: 0.35000000000000003
  - PR4: 0.02
  - NONE: 0.03

- elapsed: 0.463s
- usage: {'input_tokens': 4375, 'output_tokens': 193}
