# Run 20260920T002505Z_relop-holdout-tournament-LF3-develop_live

**Case:** relop-holdout-tournament-LF3-develop  
**Mode:** LIVE  
...
> (full page LF3 — see input.json for exact text)
...
- elapsed: 0.523s
- usage: {'input_tokens': 1373, 'output_tokens': 51}
