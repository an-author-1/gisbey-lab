# Run 20260920T002516Z_relop-holdout-tournament-LF10-contradict_live

**Case:** relop-holdout-tournament-LF10-contradict  
**Mode:** LIVE  
...
> (full page LF10 — see input.json for exact text)
...
- elapsed: 0.460s
- usage: {'input_tokens': 1327, 'output_tokens': 52}
