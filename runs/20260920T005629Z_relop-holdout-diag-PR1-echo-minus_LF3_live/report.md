# Run 20260920T005629Z_relop-holdout-diag-PR1-echo-minus_LF3_live

**Case:** relop-holdout-diag-PR1-echo-minus_LF3  
**Mode:** LIVE  
...
> (full page PR1 — see input.json for exact text)
...
- probabilities:
  ...
  - LF16: 0.0
  - PR2: 0.49
  - PR3: 0.41000000000000003
  - PR4: 0.1
  - PR5: 0.0
  - NONE: 0.0

- elapsed: 0.505s
- usage: {'input_tokens': 4138, 'output_tokens': 184}
