# Run 20260920T002518Z_relop-holdout-tournament-LF11-contradict_live

**Case:** relop-holdout-tournament-LF11-contradict  
**Mode:** LIVE  
...
> (full page LF11 — see input.json for exact text)
...
- elapsed: 0.479s
- usage: {'input_tokens': 1063, 'output_tokens': 43}
