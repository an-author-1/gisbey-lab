# Run 20260920T002519Z_relop-holdout-tournament-LF12-contradict_live

**Case:** relop-holdout-tournament-LF12-contradict  
**Mode:** LIVE  
...
> (full page LF12 — see input.json for exact text)
...
- elapsed: 0.449s
- usage: {'input_tokens': 893, 'output_tokens': 35}
