# Run 20260920T002532Z_relop-holdout-tournament-PR3-develop_live

**Case:** relop-holdout-tournament-PR3-develop  
**Mode:** LIVE  
...
> (full page PR3 — see input.json for exact text)
...
- elapsed: 0.485s
- usage: {'input_tokens': 970, 'output_tokens': 42}
