# Run 20260920T002242Z_relop-holdout-full-LF7-bridge_live

**Case:** relop-holdout-full-LF7-bridge  
**Mode:** LIVE  
...
> (full page LF7 — see input.json for exact text)
...
- elapsed: 0.557s
- usage: {'input_tokens': 4378, 'output_tokens': 192}
