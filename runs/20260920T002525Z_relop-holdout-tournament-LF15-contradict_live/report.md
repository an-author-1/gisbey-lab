# Run 20260920T002525Z_relop-holdout-tournament-LF15-contradict_live

**Case:** relop-holdout-tournament-LF15-contradict  
**Mode:** LIVE  
...
> (full page LF15 — see input.json for exact text)
...
- elapsed: 0.446s
- usage: {'input_tokens': 1008, 'output_tokens': 44}
